...
- Ensure PRD aligns with the existing project structure
- Identify which layers (frontend, backend, or both) the feature impacts
- Consider API route patterns if backend changes are needed
- Reference relevant components/utilities that may be reused
- Ensure the feature integrates with existing architecture patterns

## Final instructions

1. Do NOT start implementing the PRD
2. Review relevant architecture rules before generating the PRD
